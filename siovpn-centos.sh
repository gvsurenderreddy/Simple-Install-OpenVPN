...
## Script Name: siovpn-centos.sh Version 1.0
...
then
        wget http://download.openology.net/project/si-ovpn/adduserovpn.sh
fi
...
then
        wget http://download.openology.net/project/si-ovpn/deluserovpn.sh
fi
